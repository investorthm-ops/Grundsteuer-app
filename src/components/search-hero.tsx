    ...
    <section className="rounded-lg border bg-white p-6 sm:p-10">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-3 text-base leading-7 text-zinc-600">
          Tippe einen Gemeindenamen und sieh den aktuellen Hebesatz auf der oeffentlichen Stadtseite.
        </p>
        ...
        <p className="mt-4 text-xs text-zinc-500">
          Stadtseiten sind ohne Login einsehbar. Fuer Vergleich, Watchlist und Export anmelden.
        </p>
      </div>
    </section>
  )
